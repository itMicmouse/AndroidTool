...
package com.yangyakun.androidtool.file;
    ...
    public void onViewCreated(final View rootView, Bundle savedInstanceState) {
        ...
        openPictureButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = null;
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    intent = storageVolume.createAccessIntent(directoryName);
                }
        ...
        LinearLayout containerVolumes = mActivity
                .findViewById(R.id.container_volumes);
        for (final StorageVolume volume : storageVolumes) {
            String volumeDescription = null;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                volumeDescription = volume.getDescription(mActivity);
            }
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                if (volume.isPrimary()) {
