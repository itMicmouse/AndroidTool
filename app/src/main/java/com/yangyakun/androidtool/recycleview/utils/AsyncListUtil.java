 ...
 * <p>
 * {@link android.support.v7.util.AsyncListUtil} queries the currently visible range through {@link android.support.v7.util.AsyncListUtil.ViewCallback},
 * loads the required data items in the background through {@link android.support.v7.util.AsyncListUtil.DataCallback}, and notifies a
 * {@link android.support.v7.util.AsyncListUtil.ViewCallback} when the data is loaded. It may load some extra items for smoother
 * scrolling.
 * <p>
...
public class AsyncListUtil<T> {
    ...
    private int mScrollHint = android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_NONE;
     ...
     */
    public AsyncListUtil(Class<T> klass, int tileSize, android.support.v7.util.AsyncListUtil.DataCallback<T> dataCallback,
     ...
     * {@link android.support.v7.util.AsyncListUtil.ViewCallback#onItemLoaded(int)} will be called when it finally loads. Note that if
     * this position stays outside of the cached item range (as defined by
     * {@link android.support.v7.util.AsyncListUtil.ViewCallback#extendRangeInto} method), then the callback will never be called for
     * this position.
     *
     ...
     * {@link android.support.v7.util.AsyncListUtil.DataCallback#refreshData()}.
     *
    ...
    void updateRange() {
        ...
        if (!mAllowScrollHints) {
            mScrollHint = android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_NONE;
            ...
            mScrollHint = android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_DESC;
        } else if (mTmpRange[0] > mPrevRange[0]) {
            mScrollHint = android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_ASC;
        }
    ...
    private final ThreadUtil.BackgroundCallback<T>
        ...
        public void updateRange(int rangeStart, int rangeEnd, int extRangeStart, int extRangeEnd,
            ...
            if (scrollHint == android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_DESC) {
        ...
        private void flushTileCache(int scrollHint) {
            ...
            while (mLoadedTiles.size() >= cacheSizeLimit) {
                ...
                if (startMargin > 0 && (startMargin >= endMargin ||
                        (scrollHint == android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_ASC))) {
                    removeTile(firstLoadedTileStart);
                } else if (endMargin > 0 && (startMargin < endMargin ||
                        (scrollHint == android.support.v7.util.AsyncListUtil.ViewCallback.HINT_SCROLL_DESC))){
    ...
    /**
     * The callback that provides data access for {@link android.support.v7.util.AsyncListUtil}.
     *
     * <p>
    ...
    public static abstract class DataCallback<T> {
         ...
         * {@link android.support.v7.util.AsyncListUtil.ViewCallback#extendRangeInto(int[], int[], int)}.
         * <p>
         * For example, if this method returns 10, and the most
         * recent call to {@link android.support.v7.util.AsyncListUtil.ViewCallback#extendRangeInto(int[], int[], int)} returned
    ...
    /**
     * The callback that links {@link android.support.v7.util.AsyncListUtil} with the list view.
     *
     * <p>
