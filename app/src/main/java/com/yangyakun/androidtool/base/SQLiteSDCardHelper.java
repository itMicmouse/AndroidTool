package com.yangyakun.androidtool.base;
...
public abstract class SQLiteSDCardHelper extends SQLiteOpenHelper {
    ...
    public SQLiteSDCardHelper(Context context, String name, String storageDirectory, int version) {
        this(context, name, storageDirectory, null, version, null);
    }
